...
mod tests {
    use super::{
        CombinedExportConfig, CombinedExporter, DatabaseCombinedExportConfig,
        DatabaseCombinedExporter, DatabasePodiumExportConfig, DatabasePodiumExporter,
        ManualNameOverrides, ManualReviewPdf, ParticipationExport, ParticipationMatch,
        PodiumExport, PodiumExportConfig, PodiumExportItem, PodiumExporter, PodiumResultKind,
        apply_manual_overrides, association_label, association_matches, association_name,
